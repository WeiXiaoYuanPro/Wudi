 ...
 *
 */
public class StuFamilyModel extends Model<StuFamilyModel> {
	...
	public static final StuFamilyModel dao = new StuFamilyModel();
	 ...
	 * @return
	 */
	public static Page<StuFamilyModel> getList(int pageNumber, int pageSize,String key) {
	 ...
	 * @return
	 */
	public static StuFamilyModel getByNo(String no){
	 ...
	 * @return
	 */
	public static StuFamilyModel getById(Object id){
 ...
 */
	public static boolean save(String addr,String tel,String remark,String stu_no) {
		StuFamilyModel s=new StuFamilyModel();
	 ...
	 */
	@Before(Tx.class)
	public static boolean save(final StuFamilyModel student){
	...
	public static boolean update(String id,String addr,String tel,String remark,String stu_no){
		...
		StuFamilyModel model=StuFamilyModel.getById(id);
		if(model==null){
			return false;
		}
		model.setId(id);
