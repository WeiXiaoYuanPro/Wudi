...
public class RoleInfoModel extends Model<RoleInfoModel> {
	...
	public static final RoleInfoModel dao = new RoleInfoModel();
	 ...
	 * @return
	 */
	public static Page<RoleInfoModel> getList(int pageNumber, int pageSize,String key) {
	 ...
	 * @return
	 */
	public static RoleInfoModel getByNo(String no){
	 ...
	 * @return
	 */
	public static RoleInfoModel getById(Object id){
 ...
 */
	public static boolean save(String id,String rolename,int level,String control,String remark,String user_id) {
		RoleInfoModel s=new RoleInfoModel();
		s.setId(id);
	 ...
	 */
	@Before(Tx.class)
	public static boolean save(final RoleInfoModel role){
	...
	public static boolean update(String id,String rolename,int level,String control,String remark,String user_id){
		RoleInfoModel model=RoleInfoModel.getById(id);
		if(model==null){
			return false;
		}
		model.setId(id);
	...
	public static RoleInfoModel findModelbyUserid(String user_id) {
