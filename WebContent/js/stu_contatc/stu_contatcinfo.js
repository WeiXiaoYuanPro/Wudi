...
//==================一个table实例================================
	  table.render({
	    ...
	    cols: [[ //表头
	      ...
	      ,{field: 'tel', title: '联系电话',lign:'center'}
	      ,{field: 'qq', title: 'QQ', lign:'center'}
	      ,{field: 'weixin', title: '微信', lign:'center'} 
	      ,{field: 'other', title: '其他',align:'center' }
	      ,{field: 'stu_no', title: '学号',align:'center' }
